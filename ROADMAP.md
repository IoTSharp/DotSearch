...
**功能清单**：
- [x] `ReciprocalRankFusion.Fuse` 稳定接口
- [x] `IRankedSource` 抽象，便于接入第三方排序器
- [x] 端到端样例：全文召回 + 向量召回 + RRF 融合
...
- [x] `BenchmarkDotNet` 套件覆盖：索引吞吐、查询延迟、内存占用
- [x] 无任何 trim/AOT 警告
- [ ] Linux x64 / arm64 Native AOT 在对应 Linux runner 上验证
